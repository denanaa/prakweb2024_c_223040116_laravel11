<x-layout>
  ...
  <!-- <article class="py-8 mx-w-screen-md">
      ...
      <h2 class="mb-1 test-3xl tracking-tight font-bold text-gray-900">{{ $post['title'] }}</h2>
            ...
            <a href="/posts" class="font-medium text-xs text-blue-600 hover:underline">&laquo; Back to all posts</a>
              <address class="flex items-center my-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <div>
                          <a href="{{ $post->author->username }}" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{{ $post->author->name }}</a>
